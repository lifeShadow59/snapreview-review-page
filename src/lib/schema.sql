...
CREATE TABLE IF NOT EXISTS business_metrics (
    ...
    total_copy_count INTEGER DEFAULT 0,
...
-- Business copy metrics table for language-specific copy tracking
...
-- Trigger
 function to update total_copy_count in business_metrics
